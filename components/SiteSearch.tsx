...
const searchIndex: Record<string, SearchResult[]> = {
  en: [
    ...
    { title: 'EIN vs ITIN vs SSN', description: 'Tax ID numbers explained', href: '/en/ein-itin-ssn-farki', category: 'Tax' },
    { title: '1099 Tax Documents', description: 'Understanding 1099 forms', href: '/en/1099-vergi-belgeleri', category: 'Tax' },
    { title: 'Tax & ID Hub', description: 'All tax and ID guides', href: '/en/vergi-kimlik-rehberi', category: 'Tax' },
  ...
  tr: [
    ...
    { title: 'EIN, ITIN, SSN Farkları', description: 'Vergi kimlik numaraları', href: '/tr/ein-itin-ssn-farki', category: 'Vergi' },
    { title: '1099 Vergi Belgeleri', description: '1099 formlarını anlama', href: '/tr/1099-vergi-belgeleri', category: 'Vergi' },
    { title: 'Vergi ve Kimlik Rehberi', description: 'Tüm vergi ve kimlik rehberleri', href: '/tr/vergi-kimlik-rehberi', category: 'Vergi' },
