...
export async function generateMetadata({ params }: { params: Promise<{ lang: Locale }> }): Promise<Metadata> {
  ...
  return {
    ...
    description: isEnglish
      ? 'Free bilingual influencer/brand collaboration template. I support EchoLegal ($49 recommended) or download free. FTC compliant.'
      : 'Ücretsiz iki dilli influencer/marka işbirliği şablonu. Gücünüz kadar ödeyin (49$ önerilir) veya ücretsiz indirin.',
    alternates: {
      canonical: url,
      languages: {
    ...
    other: {
      'citation_title': isEnglish ? 'Influencer / Brand Collaboration Agreement' : 'Influencer / Marka İşbirliği Sözleşmesi',
...
export default async function InfluencerAgreementPage({
  ...
  const pageTitle = isEnglish ? 'Influencer / Brand Collaboration Agreement' : 'Influencer / Marka İşbirliği Sözleşmesi'
  ...
  const documentSchema = generateDigitalDocumentSchema({
    ...
    keywords: ['influencer-agreement', 'brand-collaboration', 'ftc-compliance', 'contract-template'],
