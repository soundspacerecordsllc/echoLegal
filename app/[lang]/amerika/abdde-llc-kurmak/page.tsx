...
import JudicialAuthoritySection from '@/components/JudicialAuthoritySection'
import type { JudicialCase } from '@/components/JudicialAuthoritySection'
...
export default async function AbddeLLCPage({
  ...
  const judicialCases: JudicialCase[] = [
    {
      caseName: 'Moline Properties, Inc. v. Commissioner',
      citation: '319 U.S. 436',
      court: 'US Supreme Court',
      year: 1943,
      holdingSummary: {
        en: 'Established the separate entity doctrine: a corporation (or other entity) formed for a legitimate business purpose will be recognized as a separate taxable entity, even if it has a single owner. Courts will not disregard the entity\'s separate existence absent a showing that the entity was a sham or lacked any business purpose beyond tax avoidance. This principle underpins the treatment of LLCs as entities distinct from their members for both liability and tax purposes.',
        tr: 'Ayrı tüzel kişilik doktrinini oluşturmuştur: meşru bir ticari amaçla kurulan bir şirket (veya diğer kuruluş), tek bir sahibi olsa dahi ayrı bir vergi mükellefi olarak tanınır. Mahkemeler, kuruluşun paravan olduğuna veya vergi kaçırma dışında hiçbir ticari amacı bulunmadığına dair kanıt olmadıkça ayrı varlığını görmezden gelmez. Bu ilke, LLC\'lerin hem sorumluluk hem de vergi açısından üyelerinden ayrı kuruluşlar olarak değerlendirilmesinin temelini oluşturur.',
      },
      interpretiveWeight: 'supreme_court',
    ...
    },
    {
      ...
      year: 1990,
      holdingSummary: {
        en: 'Held that for purposes of federal diversity jurisdiction under 28 U.S.C. § 1332, the citizenship of an unincorporated entity (such as a limited partnership or LLC) is determined by the citizenship of all its members, not by its state of formation or principal place of business. This means an LLC\'s access to federal court based on diversity depends on the citizenship of every individual member.',
        tr: '28 U.S.C. § 1332 kapsamında federal çeşitlilik yargı yetkisi bakımından, tüzel kişiliği bulunmayan bir kuruluşun (limited partnership veya LLC gibi) vatandaşlığının kuruluş eyaleti veya ana iş yerine göre değil, tüm üyelerinin vatandaşlığına göre belirlendiğine hükmetmiştir. Bu, bir LLC\'nin çeşitlilik esasına dayalı federal mahkeme erişiminin her bir üyenin vatandaşlığına bağlı olduğu anlamına gelir.',
      },
      interpretiveWeight: 'supreme_court',
    ...
    },
    {
      ...
      year: 2010,
      holdingSummary: {
        en: 'Clarified the "principal place of business" standard under 28 U.S.C. § 1332(c)(1), adopting the "nerve center" test: a corporation\'s principal place of business is the place where its high-level officers direct, control, and coordinate corporate activities — typically the headquarters. While directly applicable to corporations, this standard informs analysis of LLC management location for nexus and jurisdictional purposes.',
        tr: '28 U.S.C. § 1332(c)(1) kapsamında "ana iş yeri" standardını netleştirmiş ve "sinir merkezi" testini benimsemiştir: bir şirketin ana iş yeri, üst düzey yöneticilerin kurumsal faaliyetleri yönlendirdiği, kontrol ettiği ve koordine ettiği yerdir — genellikle genel merkezdir. Doğrudan şirketlere uygulanmakla birlikte bu standart, nexus ve yargı yetkisi amaçları bakımından LLC yönetim konumunun analizine de rehberlik eder.',
      },
      interpretiveWeight: 'supreme_court',
    ...
    },
    {
      ...
      year: 2018,
      holdingSummary: {
        en: 'Overruled the physical presence requirement of Quill Corp. v. North Dakota (1992) for state sales tax collection, holding that a state may require out-of-state sellers to collect and remit sales tax when they have an "economic nexus" with the state — defined in South Dakota\'s case as $100,000 in sales or 200 transactions annually. This decision directly affects multi-state LLC operations by expanding the circumstances under which an LLC must collect state sales tax even without physical presence.',
        tr: 'Quill Corp. v. North Dakota (1992) kararındaki eyalet satış vergisi tahsilatı için fiziksel varlık şartını ortadan kaldırmış ve bir eyaletin, eyalet dışı satıcılardan "ekonomik nexus" bulunduğunda — South Dakota\'nın tanımıyla yılda 100.000 $ satış veya 200 işlem — satış vergisi tahsilatı ve havale yapmasını talep edebileceğine hükmetmiştir. Bu karar, bir LLC\'nin fiziksel varlık olmaksızın dahi eyalet satış vergisi tahsil etmesi gereken koşulları genişleterek çok eyaletli LLC faaliyetlerini doğrudan etkiler.',
      },
      interpretiveWeight: 'supreme_court',
  ...
  return (
    <div className="bg-white">
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        {/* ===== DOCTRINAL LAYER: Judicial Authority ===== */}
        <JudicialAuthoritySection lang={lang} cases={judicialCases} />
