  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Business Starter Kit CTA */}
        <section className="bg-gradient-to-br from-amber-50 to-white border-2 border-amber-200 rounded-xl p-8">
          <h2 className="text-2xl font-bold text-black mb-4 text-center">
            {isEnglish ? 'Get Started with Essential Documents' : 'Temel Belgelerle Başlayın'}
          </h2>
          <p className="text-gray-600 text-center mb-6 max-w-xl mx-auto">
            {isEnglish
              ? 'Our Business Starter Kit includes 5 essential legal documents for starting a business in the US.'
              : "Business Starter Kit'imiz ABD'de iş kurmak için 5 temel hukuki belge içerir."}
          </p>
