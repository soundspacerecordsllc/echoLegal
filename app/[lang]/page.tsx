        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p className="text-sm text-gray-500">
              {isEnglish
                ? 'All content is jurisdiction-tagged. Current coverage includes US Federal, US State, EU, and Turkey.'
                : 'Tüm içerik yargı alanı etiketlidir. Mevcut kapsam ABD Federal, ABD Eyalet, AB ve Türkiye\'yi içermektedir.'}
            </p>
          </div>
        </div>
      </section>
