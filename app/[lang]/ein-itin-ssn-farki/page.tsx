        ...
        <header className="border-b border-gray-100">
          <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link href={`/${lang}/vergi-kimlik-rehberi`} className="text-sm font-medium hover:opacity-60">{isEnglish ? 'Tax & ID Hub' : 'Vergi ve Kimlik'}</Link>
              <Link href={`/${lang}/library`} className="text-sm font-medium hover:opacity-60">{isEnglish ? 'Library' : 'Kütüphane'}</Link>
              <Link
                href={`/${lang === 'en' ? 'tr' : 'en'}/ein-itin-ssn-farki`}
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <article>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-5 mb-10">
              <h2 className="font-bold text-blue-900 mb-2">{isEnglish ? 'Quick Summary' : 'Hızlı Özet'}</h2>
