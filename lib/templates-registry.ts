...
export const templatesRegistry: Template[] = [
  ...
  },
  {
    ...
    shortDescription: 'Mali destek taahhüdü (Affidavit of Support) hazırlamak için gereken temel bileşenler.',
    category: 'immigration',
  ...
  },
  {
    ...
    shortDescription: 'İsim değişikliği beyan belgesi için temel bileşenler.',
    category: 'personal',
  ...
  },
  {
    ...
    shortDescription: 'Hak ihlalinin durdurulmasını talep eden resmi uyarı mektubunun temel bileşenleri.',
    category: 'letters',
