...
export const amerikaHubPages: HubPage[] = [
  {
    ...
    descriptionTr: 'Göçmen ve göçmen olmayan vize kategorileri, yasal giriş yolları ve başvuru koşullarına genel bakış.',
  ...
  },
  {
    ...
    descriptionTr: 'B-1/B-2 vizesine ilişkin yaygın yanılgılar, göçmen niyeti karinesi ve ret gerekçeleri.',
  ...
  },
  {
    ...
    descriptionTr: 'Şirket ve kişisel banka hesabı açılışı, ITIN/EIN gereksinimleri ve FBAR bildirim yükümlülükleri.',
  ...
  },
  {
    ...
    descriptionTr: 'Uluslararası sözleşmelerde New York hukukunun neden sıklıkla tercih edildiği.',
  ...
  },
  {
    ...
    descriptionTr: 'EchoLegal platformunun kapsamı, sınırları ve kullanım şartları.',
