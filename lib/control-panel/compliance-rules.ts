...
export const COMPLIANCE_ITEMS: ComplianceItem[] = [
  // ── Federal: IRS ──────────────────────────────────────────────────
  {
    ...
    key: 'irs_form_5472',
    title: 'File Form 5472 + Pro Forma 1120',
    description:
      'Foreign-owned single-member LLCs must file Form 5472 attached to a pro forma Form 1120. Due by the 15th day of the 4th month after fiscal year end. $25,000 initial penalty for non-filing.',
    authority_level: 'federal',
    jurisdiction: 'federal',
    frequency: 'annual',
    severity: 'CRITICAL',
    penalty: '$25,000 initial penalty for non-filing',
  ...
  },
  {
    ...
    description:
      'File Beneficial Ownership Information report with FinCEN. New companies formed after Jan 1, 2024 must file within 90 days of formation.',
    authority_level: 'federal',
    jurisdiction: 'federal',
    frequency: 'one_time',
    severity: 'HIGH',
    penalty: 'Up to $500/day civil penalty',
  ...
  },
  {
    ...
    frequency: 'annual',
    severity: 'HIGH',
    penalty: 'Up to $10,000 per non-willful violation',
    reference_event: 'fiscal_year_end',
    offset_days: 105,
  ...
  },
  {
    ...
    title: 'Obtain EIN (Form SS-4)',
    description:
      'Employer Identification Number required for tax filing, bank accounts, and hiring.',
    authority_level: 'federal',
    jurisdiction: 'federal',
    frequency: 'one_time',
    severity: 'ROUTINE',
  ...
  },
  {
    ...
    description:
      'Non-resident owners without an SSN need an Individual Taxpayer Identification Number for tax filing.',
    authority_level: 'federal',
    jurisdiction: 'federal',
    frequency: 'one_time',
    severity: 'ROUTINE',
  ...
  },
  {
    ...
    description:
      'Ensure your registered agent designation is current. Required in the state of formation.',
    authority_level: 'federal',
    jurisdiction: 'federal',
    frequency: 'annual',
    severity: 'ROUTINE',
  ...
  // ── State-level ──────────────────────────────────────────────────
  {
    ...
    description:
      'Most states require an annual or biennial report with the Secretary of State. Deadlines and fees vary by state.',
  ...
  },
  {
    ...
    description:
      'Some states impose a franchise tax or annual business tax on LLCs. Conditional by state.',
    authority_level: 'state',
    jurisdiction: 'any',
    frequency: 'annual',
    severity: 'ROUTINE',
