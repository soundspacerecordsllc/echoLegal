...
export const consularProcedures: ConsularProcedure[] = [
  {
    ...
    descriptionEn: 'Turkish passports can be applied for at consulates abroad. Applications require biometric data collection and in-person appointment.',
    descriptionTr: 'Türk pasaportları yurt dışındaki konsolosluklarda başvurulabilir. Başvurular biyometrik veri toplama ve şahsen randevu gerektirir.',
  ...
  },
  {
    ...
    descriptionEn: 'The Turkish ID card (Kimlik) is the primary identification document for Turkish citizens. New chip-enabled cards can be obtained at consulates.',
    descriptionTr: 'T.C. Kimlik Kartı, Türk vatandaşları için birincil kimlik belgesidir. Yeni çipli kartlar konsolosluklardan alınabilir.',
  ...
  },
  {
    ...
    descriptionEn: 'Turkish consulates provide notary services including Power of Attorney (Vekaletname), revocation, consent letters, and document certification.',
    descriptionTr: 'Türk konsoloslukları Vekaletname, iptal, muvafakatname ve belge tasdiki dahil noterlik hizmetleri sunar.',
  ...
  },
  {
    ...
    descriptionTr: 'Türk vatandaşları, çocuğun Türk vatandaşlığı alması için yurt dışında gerçekleşen doğumları konsolosluğa kayıt ettirmelidir.',
  ...
  },
  {
    ...
    descriptionTr: 'Yurt dışında gerçekleştirilen evliliklerin Türkiye\'de tanınması için Türk makamlarına tescil edilmesi gerekir.',
